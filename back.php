	...
	<div id="all">
		...
		<div id="mm">
			<div class="hal" id="lef">
				<a class="blo" href="back.php?do=acc">帳號管理</a>
				<a class="blo" href="back.php?do=news">最新文章管理</a>
				<a class="blo" href="back.php?do=que">問卷管理</a>
			</div>
			<div class="hal" id="main">
				<div>
					<marquee direction="left" style="display:inline-block;width:80%">12345678</marquee>
