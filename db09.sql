...
INSERT INTO `news` (`id`, `title`, `text`, `type`, `sh`, `goods`) VALUES
...
(5, '測試分頁用(五)', '測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)測試分頁用(五)', 4, 1, 0),
(6, '測試分頁用(六)', '測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)測試分頁用(六)', 4, 1, 0);
...
INSERT INTO `que` (`id`, `text`, `subject_id`, `total`, `sh`) VALUES
(1, '今日午餐', 0, 0, 1),
(2, '中式', 1, 0, 1),
(3, '西式', 1, 0, 1),
(4, '和式', 1, 0, 1),
